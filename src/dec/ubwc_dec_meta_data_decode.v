...
module ubwc_dec_meta_data_decode #(
    ...
    input  wire        i_meta_error,
    input  wire        i_meta_eol,
    input  wire        i_meta_last_pass,
    ...
    assign o_dec_alen        = (compressed_size == 0) ? 3'd0 : (compressed_size[8:5] - 1'b1);
    assign o_dec_has_payload = (compressed_size != 0);
    assign o_dec_x           = i_meta_x;
    assign o_dec_y           = i_meta_y;

    wire unused_inputs = clk | rst_n | i_meta_error | i_meta_eol | i_meta_last_pass |
