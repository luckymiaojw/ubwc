...
module ubwc_enc_line_to_tile#(
    ...
    assign bank0_a_wr_line_base_next = bank0_a_lower_base_next ?
                                       sram_y_lower_base :
                                       (bank0_a_wr_line_base + a_wr_line_step);
    assign bank1_a_wr_line_base_next = bank1_a_lower_base_next ?
                                       sram_y_lower_base :
    ...
    assign {read_meta_fcnt, read_meta_y, read_meta_x,
            read_meta_plane, read_meta_last,
            read_meta_bank_sel} = read_meta_fifo_dout;
