...
module ubwc_dec_apb_reg_blk #(
    ...
    wire                                            cfg_rotate_active               ;
    wire                                            cfg_rotate_format_ok            ;
    assign cfg_rotate_format_ok = cfg_format_is_nv12;
    wire                                            cfg_rotate_height_ok            ;
    assign cfg_rotate_height_ok = (r_otf_cfg_h_act <= 16'd1080);
    assign cfg_rotate_active = (|r_rotate_mode) &&
                               cfg_rotate_format_ok &&
                               cfg_rotate_height_ok;
    wire        [15                     :0]         cfg_src_width                  ;
    assign cfg_src_width = cfg_rotate_active ? r_otf_cfg_img_width :
                                               r_otf_cfg_h_act;
    wire        [15                     :0]         cfg_src_height                 ;
    assign cfg_src_height = cfg_rotate_active ? r_otf_cfg_h_act :
                                                r_otf_cfg_v_act;
    wire        [17                     :0]         cfg_src_width_ext              ;
    assign cfg_src_width_ext = {2'b00, cfg_src_width};
    wire        [17                     :0]         cfg_src_height_ext             ;
    assign cfg_src_height_ext = {2'b00, cfg_src_height};
    wire        [17                     :0]         cfg_tile_x_rgba_ext            ;
    assign cfg_tile_x_rgba_ext = ((cfg_src_width_ext + 18'd63) >> 6) << 2;
    wire        [17                     :0]         cfg_tile_x_yuv_ext             ;
    assign cfg_tile_x_yuv_ext = ((cfg_src_width_ext + 18'd127) >> 7) << 2;
    wire        [17                     :0]         cfg_tile_y_4line_ext           ;
    assign cfg_tile_y_4line_ext = (cfg_src_height_ext + 18'd3) >> 2;
    wire        [17                     :0]         cfg_tile_y_8line_ext           ;
    assign cfg_tile_y_8line_ext = (cfg_src_height_ext + 18'd7) >> 3;
    ...
    always @(posedge i_axi_clk or negedge i_axi_rst_n) begin
        if (!i_axi_rst_n) begin
            ...
            if (frame_start_toggle_seen_axi) begin
                ...
                a_otf_cfg_img_width <= cfg_src_width;
    ...
    always @(*) begin
        ...
        case (apb_decode_valid ? apb_addr : 5'h1f)
            ...
            APB_ADDR_OTF_CFG0: begin
                r_prdata = {{(DW-23){1'b0}}, r_rotate_mode, r_otf_cfg_format, r_otf_cfg_img_width};
            end
            APB_ADDR_OTF_CFG1: begin
    ...
    assign o_rotate_mode                       = a_rotate_mode;
