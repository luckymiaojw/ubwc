...
//----------------------------------------------------------------------
  ...
  parameter AW_CH_FIFO_W = `ubwc_x2x_X2X_AW_CH_FIFO_W; 
      
  // SP Payloads.      
//  parameter WPYLD_W_MP  = `ubwc_x2x_X2X_WPYLD_W_MP; 
  parameter BPYLD_W_MP  = `ubwc_x2x_X2X_BPYLD_W_MP; 
  parameter ARPYLD_W_MP = `ubwc_x2x_X2X_ARPYLD_W_MP; 
  parameter RPYLD_W_MP  = `ubwc_x2x_X2X_RPYLD_W_MP;

  // MP Payloads.      
//  parameter AWPYLD_W_SP = `ubwc_x2x_X2X_AWPYLD_W_SP; 
//  parameter WPYLD_W_SP  = `ubwc_x2x_X2X_WPYLD_W_SP; 
//  parameter BPYLD_W_SP  = `ubwc_x2x_X2X_BPYLD_W_SP; 
  parameter ARPYLD_W_SP = `ubwc_x2x_X2X_ARPYLD_W_SP; 
  parameter RPYLD_W_SP  = `ubwc_x2x_X2X_RPYLD_W_SP;
  
  
  parameter MP_ID_W = `ubwc_x2x_X2X_MP_IDW; // ID width at MP.
  
  parameter ADDR_TRK_W = `ubwc_x2x_X2X_ADDR_TRK_W; // Bits of address that X2X 
                                          // requires for resizing.

//  parameter BEATS_PER_POP_W = `ubwc_x2x_X2X_SP_W_BEATS_PER_POP_W; // Beats per 
                                                         // pop width.
...
//----------------------------------------------------------------------
  ...
  input [`ubwc_x2x_X2X_NUM_W_PORTS-1:0] aw_bus_ready_i; 
  
  // Outputs
  // AW valids to all SP's.
  output [`ubwc_x2x_X2X_NUM_W_PORTS-1:0] aw_bus_valid_o; 
  ...
  input [`ubwc_x2x_X2X_NUM_W_PORTS-1:0] w_bus_pop_empty_i;
  ...
  output [`ubwc_x2x_X2X_NUM_W_PORTS-1:0] w_bus_pop_req_n_o; 

  // W EXTERNAL
  // Inputs
  // W ready signals from all slave ports.
  input [`ubwc_x2x_X2X_NUM_W_PORTS-1:0] w_bus_ready_i; 
  
  // Outputs
  // W valid signals to all slave ports.
  output [`ubwc_x2x_X2X_NUM_W_PORTS-1:0] w_bus_valid_o; 
...
//  input [`ubwc_x2x_X2X_NUM_W_PORTS-1:0] b_push_full_i;
  input b_push_full_i;
