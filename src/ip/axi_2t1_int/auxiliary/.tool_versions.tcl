...
#------------------------------------------------------------------------------#
# **************** This data is no longer used by the coreKit **************** #
#------------------------------------------------------------------------------#
set ::RCE::toolVersionsMin(MTI_Verilog) "10.6d"
set ::RCE::toolVersionsMax(MTI_Verilog) ""
set ::RCE::toolVersionsMin(NC_Verilog) "15.20.037"
set ::RCE::toolVersionsMax(NC_Verilog) ""
set ::RCE::toolVersionsMin(SpyGlass) "P-2019.06-SP2"
set ::RCE::toolVersionsMax(SpyGlass) ""
set ::RCE::toolVersionsMin(SpyGlass_SG_EngCouncil) "2019.09"
set ::RCE::toolVersionsMax(SpyGlass_SG_EngCouncil) ""
set ::RCE::toolVersionsMin(SpyGlass_SG_GuideWare) "2019.06"
set ::RCE::toolVersionsMax(SpyGlass_SG_GuideWare) ""
set ::RCE::toolVersionsMin(VCS) "P-2019.06-SP1"
set ::RCE::toolVersionsMax(VCS) ""
set ::RCE::toolVersionsMin(dc_shell) "P-2019.03-SP5"
set ::RCE::toolVersionsMax(dc_shell) ""
set ::RCE::toolVersionsMin(fm_shell) "P-2019.03-SP5"
set ::RCE::toolVersionsMax(fm_shell) ""
set ::RCE::toolVersionsMin(pt_shell) "P-2019.03-SP5"
set ::RCE::toolVersionsMax(pt_shell) ""
set ::RCE::toolVersionsMin(synplicity) "P-2019.09"
set ::RCE::toolVersionsMax(synplicity) ""
set ::RCE::toolVersionsMin(vip:amba_svt) "P-2019.06"
set ::RCE::toolVersionsMax(vip:amba_svt) ""
set ::RCE::toolVersionsMin(vip:svt) "P-2019.06"
