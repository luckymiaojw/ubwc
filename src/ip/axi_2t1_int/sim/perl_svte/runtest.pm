...
# Revision         : $Id: //dwh/DW_ocb/DW_axi/amba_dev/sim/perl/sim_svte/runtest.pm#4 $ 
#
...
my $file_prefix="axi_2t1_int_";

my $design_prefix="axi_2t1_int_";
...
sub runtestPreparation() {
  ...
  $main::ccparams_file = "${main::coreKit}/../${main::configDirName}/src/axi_2t1_int_${main::DesignName}_cc_constants.vh";
...
if (exists $main::ccparams{'axi_2t1_int_USE_FOUNDATION'}) 
  {
if ($main::ccparams{'axi_2t1_int_USE_FOUNDATION'} eq 1) 
    { 
...
sub runSim() {
  ...
  if ($main::Simulator eq "vcs" and $main::platform eq "HP-UX") {
    ...
    @Commands = ("vcs -debug_access+nomemcbk+dmptf -debug_region+cell $PlatformFlags $cm_cflags $cm_xprop_cfags $vcs_vera_bind -f $main::simcommand -f $main::plusargs",
                 "/bin/rm -fr *.o",
                 "./simv $cm_rflags",
                 "rm -f simv");
  } elsif ($main::Simulator eq "vcsi" and $main::platform eq "HP-UX") {
    my $PlatformFlags = "$sixtyfourbitswitch -Mupdate=1";
    @Commands = ("vcsi -debug_access+nomemcbk+dmptf -debug_region+cell $PlatformFlags $cm_cflags $cm_xprop_cfags $vcs_vera_bind -f $main::simcommand -f $main::plusargs",
                 "/bin/rm -fr *.o",
                 "./simv $cm_rflags",
                 "rm -f simv");
