...
`define AXI_NUM_SLAVES 1
`define AXI_LOG2_NS 1
`define AXI_LOG2_NM 1
`define AXI_LOG2_LCL_NMP1 2
`define AXI_LOG2_LCL_NM 1
`define AXI_LOG2_NSP1 1
`define AXI_NSP1 2
`define AXI_LOG2_NSP2 2
`define AXI_MIDW 6
`define AXI_POW2_MIDW 64
`define AXI_SIDW 7
`define AXI_BLW 8
...
`define AXI_NV_S2_BY_ANY_M 0
`define AXI_NV_S3_BY_ANY_M 0
...
`define AXI_NNMV_S2 0
`define AXI_BNMV_S2 0
`define AXI_NNMV_S3 0
...
`define AXI_NSP1V_M1 2
`define AXI_LOG2_NSP1V_M1 1
`define AXI_LOG2_NSP2V_M1 2
`define AXI_NSP1V_M2 2
...
`define AXI_R_M1_NSV 2
`define AXI_R_M1_NSV_LOG2 1
`define AXI_R_M1_NSV_P1_LOG2 2
`define AXI_B_M1_HAS_SHRD_DDCTD_LNK_VAL 0
`define AXI_B_M1_NSV 2
`define AXI_B_M1_NSV_LOG2 1
`define AXI_B_M1_NSV_P1_LOG2 2
`define AXI_R_M2_HAS_SHRD_DDCTD_LNK_VAL 0
`define AXI_R_M2_NSV 2
`define AXI_R_M2_NSV_LOG2 1
`define AXI_R_M2_NSV_P1_LOG2 2
`define AXI_B_M2_HAS_SHRD_DDCTD_LNK_VAL 0
`define AXI_B_M2_NSV 2
`define AXI_B_M2_NSV_LOG2 1
`define AXI_B_M2_NSV_P1_LOG2 2
...
`define AXI_S2_ON_AR_SHARED_ONLY_VAL 1
`define AXI_S3_ON_AR_SHARED_VAL 0
`define AXI_S3_ON_AR_SHARED_ONLY
`define AXI_S3_ON_AR_SHARED_ONLY_VAL 1
...
`define AXI_S2_ON_AW_SHARED_ONLY_VAL 1
`define AXI_S3_ON_AW_SHARED_VAL 0
`define AXI_S3_ON_AW_SHARED_ONLY
`define AXI_S3_ON_AW_SHARED_ONLY_VAL 1
...
`define AXI_S2_ON_W_SHARED_ONLY_VAL 1
`define AXI_S3_ON_W_SHARED_VAL 0
`define AXI_S3_ON_W_SHARED_ONLY
`define AXI_S3_ON_W_SHARED_ONLY_VAL 1
...
`define AXI_R1_NSA_S1 64'h0
`define AXI_R1_NEA_S1 64'hfffffffff
`define AXI_R1_NSA_S2 64'ha000000
`define AXI_R1_NEA_S2 64'ha00ffff
`define AXI_R1_NSA_S3 64'hc000000
`define AXI_R1_NEA_S3 64'hc00ffff
`define AXI_R1_NSA_S4 64'he000000
`define AXI_R1_NEA_S4 64'he00ffff
`define AXI_R1_NSA_S5 64'h10000000
`define AXI_R1_NEA_S5 64'h1000ffff
`define AXI_R1_NSA_S6 64'h12000000
`define AXI_R1_NEA_S6 64'h1200ffff
`define AXI_R1_NSA_S7 64'h14000000
`define AXI_R1_NEA_S7 64'h1400ffff
`define AXI_R1_NSA_S8 64'h16000000
`define AXI_R1_NEA_S8 64'h1600ffff
`define AXI_R1_NSA_S9 64'h18000000
`define AXI_R1_NEA_S9 64'h1800ffff
`define AXI_R1_NSA_S10 64'h1a000000
`define AXI_R1_NEA_S10 64'h1a00ffff
`define AXI_R1_NSA_S11 64'h1c000000
`define AXI_R1_NEA_S11 64'h1c00ffff
`define AXI_R1_NSA_S12 64'h1e000000
`define AXI_R1_NEA_S12 64'h1e00ffff
`define AXI_R1_NSA_S13 64'h20000000
`define AXI_R1_NEA_S13 64'h2000ffff
`define AXI_R1_NSA_S14 64'h22000000
`define AXI_R1_NEA_S14 64'h2200ffff
`define AXI_R1_NSA_S15 64'h24000000
`define AXI_R1_NEA_S15 64'h2400ffff
`define AXI_R1_NSA_S16 64'h26000000
`define AXI_R1_NEA_S16 64'h2600ffff
`define AXI_R2_NSA_S1 64'h3000000
`define AXI_R2_NEA_S1 64'h300ffff
`define AXI_R2_NSA_S2 64'hb000000
`define AXI_R2_NEA_S2 64'hb00ffff
`define AXI_R2_NSA_S3 64'hd000000
`define AXI_R2_NEA_S3 64'hd00ffff
`define AXI_R2_NSA_S4 64'hf000000
`define AXI_R2_NEA_S4 64'hf00ffff
`define AXI_R2_NSA_S5 64'h11000000
`define AXI_R2_NEA_S5 64'h1100ffff
`define AXI_R2_NSA_S6 64'h13000000
`define AXI_R2_NEA_S6 64'h1300ffff
`define AXI_R2_NSA_S7 64'h15000000
`define AXI_R2_NEA_S7 64'h1500ffff
`define AXI_R2_NSA_S8 64'h17000000
`define AXI_R2_NEA_S8 64'h1700ffff
`define AXI_R2_NSA_S9 64'h19000000
`define AXI_R2_NEA_S9 64'h1900ffff
`define AXI_R2_NSA_S10 64'h1b000000
`define AXI_R2_NEA_S10 64'h1b00ffff
`define AXI_R2_NSA_S11 64'h1d000000
`define AXI_R2_NEA_S11 64'h1d00ffff
`define AXI_R2_NSA_S12 64'h1f000000
`define AXI_R2_NEA_S12 64'h1f00ffff
`define AXI_R2_NSA_S13 64'h21000000
`define AXI_R2_NEA_S13 64'h2100ffff
`define AXI_R2_NSA_S14 64'h23000000
`define AXI_R2_NEA_S14 64'h2300ffff
`define AXI_R2_NSA_S15 64'h25000000
`define AXI_R2_NEA_S15 64'h2500ffff
`define AXI_R2_NSA_S16 64'h27000000
`define AXI_R2_NEA_S16 64'h2700ffff
`define AXI_R3_NSA_S1 64'h4010000
`define AXI_R3_NEA_S1 64'h401ffff
`define AXI_R3_NSA_S2 64'h4020000
`define AXI_R3_NEA_S2 64'h402ffff
`define AXI_R3_NSA_S3 64'h4030000
`define AXI_R3_NEA_S3 64'h403ffff
`define AXI_R3_NSA_S4 64'h4040000
`define AXI_R3_NEA_S4 64'h404ffff
`define AXI_R3_NSA_S5 64'h4050000
`define AXI_R3_NEA_S5 64'h405ffff
`define AXI_R3_NSA_S6 64'h4060000
`define AXI_R3_NEA_S6 64'h406ffff
`define AXI_R3_NSA_S7 64'h4070000
`define AXI_R3_NEA_S7 64'h407ffff
`define AXI_R3_NSA_S8 64'h4080000
`define AXI_R3_NEA_S8 64'h408ffff
`define AXI_R3_NSA_S9 64'h4090000
`define AXI_R3_NEA_S9 64'h409ffff
`define AXI_R3_NSA_S10 64'h40a0000
`define AXI_R3_NEA_S10 64'h40affff
`define AXI_R3_NSA_S11 64'h40b0000
`define AXI_R3_NEA_S11 64'h40bffff
`define AXI_R3_NSA_S12 64'h40c0000
`define AXI_R3_NEA_S12 64'h40cffff
`define AXI_R3_NSA_S13 64'h40d0000
`define AXI_R3_NEA_S13 64'h40dffff
`define AXI_R3_NSA_S14 64'h40e0000
`define AXI_R3_NEA_S14 64'h40effff
`define AXI_R3_NSA_S15 64'h40f0000
`define AXI_R3_NEA_S15 64'h40fffff
`define AXI_R3_NSA_S16 64'h4000000
`define AXI_R3_NEA_S16 64'h400ffff
`define AXI_R4_NSA_S1 64'h5010000
`define AXI_R4_NEA_S1 64'h501ffff
`define AXI_R4_NSA_S2 64'h5020000
`define AXI_R4_NEA_S2 64'h502ffff
`define AXI_R4_NSA_S3 64'h5030000
`define AXI_R4_NEA_S3 64'h503ffff
`define AXI_R4_NSA_S4 64'h5040000
`define AXI_R4_NEA_S4 64'h504ffff
`define AXI_R4_NSA_S5 64'h5050000
`define AXI_R4_NEA_S5 64'h505ffff
`define AXI_R4_NSA_S6 64'h5060000
`define AXI_R4_NEA_S6 64'h506ffff
`define AXI_R4_NSA_S7 64'h5070000
`define AXI_R4_NEA_S7 64'h507ffff
`define AXI_R4_NSA_S8 64'h5080000
`define AXI_R4_NEA_S8 64'h508ffff
`define AXI_R4_NSA_S9 64'h5090000
`define AXI_R4_NEA_S9 64'h509ffff
`define AXI_R4_NSA_S10 64'h50a0000
`define AXI_R4_NEA_S10 64'h50affff
`define AXI_R4_NSA_S11 64'h50b0000
`define AXI_R4_NEA_S11 64'h50bffff
`define AXI_R4_NSA_S12 64'h50c0000
`define AXI_R4_NEA_S12 64'h50cffff
`define AXI_R4_NSA_S13 64'h50d0000
`define AXI_R4_NEA_S13 64'h50dffff
`define AXI_R4_NSA_S14 64'h50e0000
`define AXI_R4_NEA_S14 64'h50effff
`define AXI_R4_NSA_S15 64'h50f0000
`define AXI_R4_NEA_S15 64'h50fffff
`define AXI_R4_NSA_S16 64'h5000000
`define AXI_R4_NEA_S16 64'h500ffff
`define AXI_R5_NSA_S1 64'h6010000
`define AXI_R5_NEA_S1 64'h601ffff
`define AXI_R5_NSA_S2 64'h6020000
`define AXI_R5_NEA_S2 64'h602ffff
`define AXI_R5_NSA_S3 64'h6030000
`define AXI_R5_NEA_S3 64'h603ffff
`define AXI_R5_NSA_S4 64'h6040000
`define AXI_R5_NEA_S4 64'h604ffff
`define AXI_R5_NSA_S5 64'h6050000
`define AXI_R5_NEA_S5 64'h605ffff
`define AXI_R5_NSA_S6 64'h6060000
`define AXI_R5_NEA_S6 64'h606ffff
`define AXI_R5_NSA_S7 64'h6070000
`define AXI_R5_NEA_S7 64'h607ffff
`define AXI_R5_NSA_S8 64'h6080000
`define AXI_R5_NEA_S8 64'h608ffff
`define AXI_R5_NSA_S9 64'h6090000
`define AXI_R5_NEA_S9 64'h609ffff
`define AXI_R5_NSA_S10 64'h60a0000
`define AXI_R5_NEA_S10 64'h60affff
`define AXI_R5_NSA_S11 64'h60b0000
`define AXI_R5_NEA_S11 64'h60bffff
`define AXI_R5_NSA_S12 64'h60c0000
`define AXI_R5_NEA_S12 64'h60cffff
`define AXI_R5_NSA_S13 64'h60d0000
`define AXI_R5_NEA_S13 64'h60dffff
`define AXI_R5_NSA_S14 64'h60e0000
`define AXI_R5_NEA_S14 64'h60effff
`define AXI_R5_NSA_S15 64'h60f0000
`define AXI_R5_NEA_S15 64'h60fffff
`define AXI_R5_NSA_S16 64'h6000000
`define AXI_R5_NEA_S16 64'h600ffff
`define AXI_R6_NSA_S1 64'h7010000
`define AXI_R6_NEA_S1 64'h701ffff
`define AXI_R6_NSA_S2 64'h7020000
`define AXI_R6_NEA_S2 64'h702ffff
`define AXI_R6_NSA_S3 64'h7030000
`define AXI_R6_NEA_S3 64'h703ffff
`define AXI_R6_NSA_S4 64'h7040000
`define AXI_R6_NEA_S4 64'h704ffff
`define AXI_R6_NSA_S5 64'h7050000
`define AXI_R6_NEA_S5 64'h705ffff
`define AXI_R6_NSA_S6 64'h7060000
`define AXI_R6_NEA_S6 64'h706ffff
`define AXI_R6_NSA_S7 64'h7070000
`define AXI_R6_NEA_S7 64'h707ffff
`define AXI_R6_NSA_S8 64'h7080000
`define AXI_R6_NEA_S8 64'h708ffff
`define AXI_R6_NSA_S9 64'h7090000
`define AXI_R6_NEA_S9 64'h709ffff
`define AXI_R6_NSA_S10 64'h70a0000
`define AXI_R6_NEA_S10 64'h70affff
`define AXI_R6_NSA_S11 64'h70b0000
`define AXI_R6_NEA_S11 64'h70bffff
`define AXI_R6_NSA_S12 64'h70c0000
`define AXI_R6_NEA_S12 64'h70cffff
`define AXI_R6_NSA_S13 64'h70d0000
`define AXI_R6_NEA_S13 64'h70dffff
`define AXI_R6_NSA_S14 64'h70e0000
`define AXI_R6_NEA_S14 64'h70effff
`define AXI_R6_NSA_S15 64'h70f0000
`define AXI_R6_NEA_S15 64'h70fffff
`define AXI_R6_NSA_S16 64'h7000000
`define AXI_R6_NEA_S16 64'h700ffff
`define AXI_R7_NSA_S1 64'h8010000
`define AXI_R7_NEA_S1 64'h801ffff
`define AXI_R7_NSA_S2 64'h8020000
`define AXI_R7_NEA_S2 64'h802ffff
`define AXI_R7_NSA_S3 64'h8030000
`define AXI_R7_NEA_S3 64'h803ffff
`define AXI_R7_NSA_S4 64'h8040000
`define AXI_R7_NEA_S4 64'h804ffff
`define AXI_R7_NSA_S5 64'h8050000
`define AXI_R7_NEA_S5 64'h805ffff
`define AXI_R7_NSA_S6 64'h8060000
`define AXI_R7_NEA_S6 64'h806ffff
`define AXI_R7_NSA_S7 64'h8070000
`define AXI_R7_NEA_S7 64'h807ffff
`define AXI_R7_NSA_S8 64'h8080000
`define AXI_R7_NEA_S8 64'h808ffff
`define AXI_R7_NSA_S9 64'h8090000
`define AXI_R7_NEA_S9 64'h809ffff
`define AXI_R7_NSA_S10 64'h80a0000
`define AXI_R7_NEA_S10 64'h80affff
`define AXI_R7_NSA_S11 64'h80b0000
`define AXI_R7_NEA_S11 64'h80bffff
`define AXI_R7_NSA_S12 64'h80c0000
`define AXI_R7_NEA_S12 64'h80cffff
`define AXI_R7_NSA_S13 64'h80d0000
`define AXI_R7_NEA_S13 64'h80dffff
`define AXI_R7_NSA_S14 64'h80e0000
`define AXI_R7_NEA_S14 64'h80effff
`define AXI_R7_NSA_S15 64'h80f0000
`define AXI_R7_NEA_S15 64'h80fffff
`define AXI_R7_NSA_S16 64'h8000000
`define AXI_R7_NEA_S16 64'h800ffff
`define AXI_R8_NSA_S1 64'h9010000
`define AXI_R8_NEA_S1 64'h901ffff
`define AXI_R8_NSA_S2 64'h9020000
`define AXI_R8_NEA_S2 64'h902ffff
`define AXI_R8_NSA_S3 64'h9030000
`define AXI_R8_NEA_S3 64'h903ffff
`define AXI_R8_NSA_S4 64'h9040000
`define AXI_R8_NEA_S4 64'h904ffff
`define AXI_R8_NSA_S5 64'h9050000
`define AXI_R8_NEA_S5 64'h905ffff
`define AXI_R8_NSA_S6 64'h9060000
`define AXI_R8_NEA_S6 64'h906ffff
`define AXI_R8_NSA_S7 64'h9070000
`define AXI_R8_NEA_S7 64'h907ffff
`define AXI_R8_NSA_S8 64'h9080000
`define AXI_R8_NEA_S8 64'h908ffff
`define AXI_R8_NSA_S9 64'h9090000
`define AXI_R8_NEA_S9 64'h909ffff
`define AXI_R8_NSA_S10 64'h90a0000
`define AXI_R8_NEA_S10 64'h90affff
`define AXI_R8_NSA_S11 64'h90b0000
`define AXI_R8_NEA_S11 64'h90bffff
`define AXI_R8_NSA_S12 64'h90c0000
`define AXI_R8_NEA_S12 64'h90cffff
`define AXI_R8_NSA_S13 64'h90d0000
`define AXI_R8_NEA_S13 64'h90dffff
`define AXI_R8_NSA_S14 64'h90e0000
`define AXI_R8_NEA_S14 64'h90effff
`define AXI_R8_NSA_S15 64'h90f0000
`define AXI_R8_NEA_S15 64'h90fffff
`define AXI_R8_NSA_S16 64'h9000000
`define AXI_R8_NEA_S16 64'h900ffff
...
`define AXI_R1_BSA_S1 64'h2000000
`define AXI_R1_BEA_S1 64'h200ffff
`define AXI_R1_BSA_S2 64'ha000000
`define AXI_R1_BEA_S2 64'ha00ffff
`define AXI_R1_BSA_S3 64'hc000000
`define AXI_R1_BEA_S3 64'hc00ffff
`define AXI_R1_BSA_S4 64'he000000
`define AXI_R1_BEA_S4 64'he00ffff
`define AXI_R1_BSA_S5 64'h10000000
`define AXI_R1_BEA_S5 64'h1000ffff
`define AXI_R1_BSA_S6 64'h12000000
`define AXI_R1_BEA_S6 64'h1200ffff
`define AXI_R1_BSA_S7 64'h14000000
`define AXI_R1_BEA_S7 64'h1400ffff
`define AXI_R1_BSA_S8 64'h16000000
`define AXI_R1_BEA_S8 64'h1600ffff
`define AXI_R1_BSA_S9 64'h18000000
`define AXI_R1_BEA_S9 64'h1800ffff
`define AXI_R1_BSA_S10 64'h1a000000
`define AXI_R1_BEA_S10 64'h1a00ffff
`define AXI_R1_BSA_S11 64'h1c000000
`define AXI_R1_BEA_S11 64'h1c00ffff
`define AXI_R1_BSA_S12 64'h1e000000
`define AXI_R1_BEA_S12 64'h1e00ffff
`define AXI_R1_BSA_S13 64'h20000000
`define AXI_R1_BEA_S13 64'h2000ffff
`define AXI_R1_BSA_S14 64'h22000000
`define AXI_R1_BEA_S14 64'h2200ffff
`define AXI_R1_BSA_S15 64'h24000000
`define AXI_R1_BEA_S15 64'h2400ffff
`define AXI_R1_BSA_S16 64'h26000000
`define AXI_R1_BEA_S16 64'h2600ffff
`define AXI_R2_BSA_S1 64'h3000000
`define AXI_R2_BEA_S1 64'h300ffff
`define AXI_R2_BSA_S2 64'hb000000
`define AXI_R2_BEA_S2 64'hb00ffff
`define AXI_R2_BSA_S3 64'hd000000
`define AXI_R2_BEA_S3 64'hd00ffff
`define AXI_R2_BSA_S4 64'hf000000
`define AXI_R2_BEA_S4 64'hf00ffff
`define AXI_R2_BSA_S5 64'h11000000
`define AXI_R2_BEA_S5 64'h1100ffff
`define AXI_R2_BSA_S6 64'h13000000
`define AXI_R2_BEA_S6 64'h1300ffff
`define AXI_R2_BSA_S7 64'h15000000
`define AXI_R2_BEA_S7 64'h1500ffff
`define AXI_R2_BSA_S8 64'h17000000
`define AXI_R2_BEA_S8 64'h1700ffff
`define AXI_R2_BSA_S9 64'h19000000
`define AXI_R2_BEA_S9 64'h1900ffff
`define AXI_R2_BSA_S10 64'h1b000000
`define AXI_R2_BEA_S10 64'h1b00ffff
`define AXI_R2_BSA_S11 64'h1d000000
`define AXI_R2_BEA_S11 64'h1d00ffff
`define AXI_R2_BSA_S12 64'h1f000000
`define AXI_R2_BEA_S12 64'h1f00ffff
`define AXI_R2_BSA_S13 64'h21000000
`define AXI_R2_BEA_S13 64'h2100ffff
`define AXI_R2_BSA_S14 64'h23000000
`define AXI_R2_BEA_S14 64'h2300ffff
`define AXI_R2_BSA_S15 64'h25000000
`define AXI_R2_BEA_S15 64'h2500ffff
`define AXI_R2_BSA_S16 64'h27000000
`define AXI_R2_BEA_S16 64'h2700ffff
`define AXI_R3_BSA_S1 64'h4010000
`define AXI_R3_BEA_S1 64'h401ffff
`define AXI_R3_BSA_S2 64'h4020000
`define AXI_R3_BEA_S2 64'h402ffff
`define AXI_R3_BSA_S3 64'h4030000
`define AXI_R3_BEA_S3 64'h403ffff
`define AXI_R3_BSA_S4 64'h4040000
`define AXI_R3_BEA_S4 64'h404ffff
`define AXI_R3_BSA_S5 64'h4050000
`define AXI_R3_BEA_S5 64'h405ffff
`define AXI_R3_BSA_S6 64'h4060000
`define AXI_R3_BEA_S6 64'h406ffff
`define AXI_R3_BSA_S7 64'h4070000
`define AXI_R3_BEA_S7 64'h407ffff
`define AXI_R3_BSA_S8 64'h4080000
`define AXI_R3_BEA_S8 64'h408ffff
`define AXI_R3_BSA_S9 64'h4090000
`define AXI_R3_BEA_S9 64'h409ffff
`define AXI_R3_BSA_S10 64'h40a0000
`define AXI_R3_BEA_S10 64'h40affff
`define AXI_R3_BSA_S11 64'h40b0000
`define AXI_R3_BEA_S11 64'h40bffff
`define AXI_R3_BSA_S12 64'h40c0000
`define AXI_R3_BEA_S12 64'h40cffff
`define AXI_R3_BSA_S13 64'h40d0000
`define AXI_R3_BEA_S13 64'h40dffff
`define AXI_R3_BSA_S14 64'h40e0000
`define AXI_R3_BEA_S14 64'h40effff
`define AXI_R3_BSA_S15 64'h40f0000
`define AXI_R3_BEA_S15 64'h40fffff
`define AXI_R3_BSA_S16 64'h4000000
`define AXI_R3_BEA_S16 64'h400ffff
`define AXI_R4_BSA_S1 64'h5010000
`define AXI_R4_BEA_S1 64'h501ffff
`define AXI_R4_BSA_S2 64'h5020000
`define AXI_R4_BEA_S2 64'h502ffff
`define AXI_R4_BSA_S3 64'h5030000
`define AXI_R4_BEA_S3 64'h503ffff
`define AXI_R4_BSA_S4 64'h5040000
`define AXI_R4_BEA_S4 64'h504ffff
`define AXI_R4_BSA_S5 64'h5050000
`define AXI_R4_BEA_S5 64'h505ffff
`define AXI_R4_BSA_S6 64'h5060000
`define AXI_R4_BEA_S6 64'h506ffff
`define AXI_R4_BSA_S7 64'h5070000
`define AXI_R4_BEA_S7 64'h507ffff
`define AXI_R4_BSA_S8 64'h5080000
`define AXI_R4_BEA_S8 64'h508ffff
`define AXI_R4_BSA_S9 64'h5090000
`define AXI_R4_BEA_S9 64'h509ffff
`define AXI_R4_BSA_S10 64'h50a0000
`define AXI_R4_BEA_S10 64'h50affff
`define AXI_R4_BSA_S11 64'h50b0000
`define AXI_R4_BEA_S11 64'h50bffff
`define AXI_R4_BSA_S12 64'h50c0000
`define AXI_R4_BEA_S12 64'h50cffff
`define AXI_R4_BSA_S13 64'h50d0000
`define AXI_R4_BEA_S13 64'h50dffff
`define AXI_R4_BSA_S14 64'h50e0000
`define AXI_R4_BEA_S14 64'h50effff
`define AXI_R4_BSA_S15 64'h50f0000
`define AXI_R4_BEA_S15 64'h50fffff
`define AXI_R4_BSA_S16 64'h5000000
`define AXI_R4_BEA_S16 64'h500ffff
`define AXI_R5_BSA_S1 64'h6010000
`define AXI_R5_BEA_S1 64'h601ffff
`define AXI_R5_BSA_S2 64'h6020000
`define AXI_R5_BEA_S2 64'h602ffff
`define AXI_R5_BSA_S3 64'h6030000
`define AXI_R5_BEA_S3 64'h603ffff
`define AXI_R5_BSA_S4 64'h6040000
`define AXI_R5_BEA_S4 64'h604ffff
`define AXI_R5_BSA_S5 64'h6050000
`define AXI_R5_BEA_S5 64'h605ffff
`define AXI_R5_BSA_S6 64'h6060000
`define AXI_R5_BEA_S6 64'h606ffff
`define AXI_R5_BSA_S7 64'h6070000
`define AXI_R5_BEA_S7 64'h607ffff
`define AXI_R5_BSA_S8 64'h6080000
`define AXI_R5_BEA_S8 64'h608ffff
`define AXI_R5_BSA_S9 64'h6090000
`define AXI_R5_BEA_S9 64'h609ffff
`define AXI_R5_BSA_S10 64'h60a0000
`define AXI_R5_BEA_S10 64'h60affff
`define AXI_R5_BSA_S11 64'h60b0000
`define AXI_R5_BEA_S11 64'h60bffff
`define AXI_R5_BSA_S12 64'h60c0000
`define AXI_R5_BEA_S12 64'h60cffff
`define AXI_R5_BSA_S13 64'h60d0000
`define AXI_R5_BEA_S13 64'h60dffff
`define AXI_R5_BSA_S14 64'h60e0000
`define AXI_R5_BEA_S14 64'h60effff
`define AXI_R5_BSA_S15 64'h60f0000
`define AXI_R5_BEA_S15 64'h60fffff
`define AXI_R5_BSA_S16 64'h6000000
`define AXI_R5_BEA_S16 64'h600ffff
`define AXI_R6_BSA_S1 64'h7010000
`define AXI_R6_BEA_S1 64'h701ffff
`define AXI_R6_BSA_S2 64'h7020000
`define AXI_R6_BEA_S2 64'h702ffff
`define AXI_R6_BSA_S3 64'h7030000
`define AXI_R6_BEA_S3 64'h703ffff
`define AXI_R6_BSA_S4 64'h7040000
`define AXI_R6_BEA_S4 64'h704ffff
`define AXI_R6_BSA_S5 64'h7050000
`define AXI_R6_BEA_S5 64'h705ffff
`define AXI_R6_BSA_S6 64'h7060000
`define AXI_R6_BEA_S6 64'h706ffff
`define AXI_R6_BSA_S7 64'h7070000
`define AXI_R6_BEA_S7 64'h707ffff
`define AXI_R6_BSA_S8 64'h7080000
`define AXI_R6_BEA_S8 64'h708ffff
`define AXI_R6_BSA_S9 64'h7090000
`define AXI_R6_BEA_S9 64'h709ffff
`define AXI_R6_BSA_S10 64'h70a0000
`define AXI_R6_BEA_S10 64'h70affff
`define AXI_R6_BSA_S11 64'h70b0000
`define AXI_R6_BEA_S11 64'h70bffff
`define AXI_R6_BSA_S12 64'h70c0000
`define AXI_R6_BEA_S12 64'h70cffff
`define AXI_R6_BSA_S13 64'h70d0000
`define AXI_R6_BEA_S13 64'h70dffff
`define AXI_R6_BSA_S14 64'h70e0000
`define AXI_R6_BEA_S14 64'h70effff
`define AXI_R6_BSA_S15 64'h70f0000
`define AXI_R6_BEA_S15 64'h70fffff
`define AXI_R6_BSA_S16 64'h7000000
`define AXI_R6_BEA_S16 64'h700ffff
`define AXI_R7_BSA_S1 64'h8010000
`define AXI_R7_BEA_S1 64'h801ffff
`define AXI_R7_BSA_S2 64'h8020000
`define AXI_R7_BEA_S2 64'h802ffff
`define AXI_R7_BSA_S3 64'h8030000
`define AXI_R7_BEA_S3 64'h803ffff
`define AXI_R7_BSA_S4 64'h8040000
`define AXI_R7_BEA_S4 64'h804ffff
`define AXI_R7_BSA_S5 64'h8050000
`define AXI_R7_BEA_S5 64'h805ffff
`define AXI_R7_BSA_S6 64'h8060000
`define AXI_R7_BEA_S6 64'h806ffff
`define AXI_R7_BSA_S7 64'h8070000
`define AXI_R7_BEA_S7 64'h807ffff
`define AXI_R7_BSA_S8 64'h8080000
`define AXI_R7_BEA_S8 64'h808ffff
`define AXI_R7_BSA_S9 64'h8090000
`define AXI_R7_BEA_S9 64'h809ffff
`define AXI_R7_BSA_S10 64'h80a0000
`define AXI_R7_BEA_S10 64'h80affff
`define AXI_R7_BSA_S11 64'h80b0000
`define AXI_R7_BEA_S11 64'h80bffff
`define AXI_R7_BSA_S12 64'h80c0000
`define AXI_R7_BEA_S12 64'h80cffff
`define AXI_R7_BSA_S13 64'h80d0000
`define AXI_R7_BEA_S13 64'h80dffff
`define AXI_R7_BSA_S14 64'h80e0000
`define AXI_R7_BEA_S14 64'h80effff
`define AXI_R7_BSA_S15 64'h80f0000
`define AXI_R7_BEA_S15 64'h80fffff
`define AXI_R7_BSA_S16 64'h8000000
`define AXI_R7_BEA_S16 64'h800ffff
`define AXI_R8_BSA_S1 64'h9010000
`define AXI_R8_BEA_S1 64'h901ffff
`define AXI_R8_BSA_S2 64'h9020000
`define AXI_R8_BEA_S2 64'h902ffff
`define AXI_R8_BSA_S3 64'h9030000
`define AXI_R8_BEA_S3 64'h903ffff
`define AXI_R8_BSA_S4 64'h9040000
`define AXI_R8_BEA_S4 64'h904ffff
`define AXI_R8_BSA_S5 64'h9050000
`define AXI_R8_BEA_S5 64'h905ffff
`define AXI_R8_BSA_S6 64'h9060000
`define AXI_R8_BEA_S6 64'h906ffff
`define AXI_R8_BSA_S7 64'h9070000
`define AXI_R8_BEA_S7 64'h907ffff
`define AXI_R8_BSA_S8 64'h9080000
`define AXI_R8_BEA_S8 64'h908ffff
`define AXI_R8_BSA_S9 64'h9090000
`define AXI_R8_BEA_S9 64'h909ffff
`define AXI_R8_BSA_S10 64'h90a0000
`define AXI_R8_BEA_S10 64'h90affff
`define AXI_R8_BSA_S11 64'h90b0000
`define AXI_R8_BEA_S11 64'h90bffff
`define AXI_R8_BSA_S12 64'h90c0000
`define AXI_R8_BEA_S12 64'h90cffff
`define AXI_R8_BSA_S13 64'h90d0000
`define AXI_R8_BEA_S13 64'h90dffff
`define AXI_R8_BSA_S14 64'h90e0000
`define AXI_R8_BEA_S14 64'h90effff
`define AXI_R8_BSA_S15 64'h90f0000
`define AXI_R8_BEA_S15 64'h90fffff
`define AXI_R8_BSA_S16 64'h9000000
`define AXI_R8_BEA_S16 64'h900ffff
`define AXI_AR_PYLD_M_W 91
`define AXI_AW_PYLD_M_W 91
`define AXI_W_PYLD_M_W 295
`define AXI_R_PYLD_M_W 265
`define AXI_B_PYLD_M_W 8
`define AXI_AR_PYLD_S_W 92
`define AXI_AW_PYLD_S_W 92
`define AXI_W_PYLD_S_W 296
`define AXI_R_PYLD_S_W 266
`define AXI_B_PYLD_S_W 9
`define AXI_HAS_S0
`define AXI_HAS_S1
`define AXI_HAS_M1
`define AXI_HAS_M2
