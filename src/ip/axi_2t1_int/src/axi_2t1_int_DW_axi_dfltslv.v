...
module axi_2t1_int_DW_axi_dfltslv(
    // Inputs - System
    aclk_i,                  
    aresetn_i,               
  ...
  input [`axi_2t1_int_AXI_BLW-1:0]  arlen_i;         // Burst Length
  //spyglass disable_block W240
  //SMD: An input has been declared but is not read
  //SJ: These ports are not used 
  input [`axi_2t1_int_AXI_AW-1:0]  araddr_i;
  input [`axi_2t1_int_AXI_BSW-1:0]  arsize_i;
  input [`axi_2t1_int_AXI_LTW-1:0]  arlock_i;
  input [`axi_2t1_int_AXI_BTW-1:0]  arburst_i;
  input [`axi_2t1_int_AXI_CTW-1:0]  arcache_i;
  input [`axi_2t1_int_AXI_PTW-1:0]  arprot_i;
  ...
  output [`axi_2t1_int_AXI_RRW-1:0]   rresp_o;     // Read response
  output [`axi_2t1_int_AXI_DW-1:0]    rdata_o;     // Read data
  ...
  input [`axi_2t1_int_AXI_BLW-1:0] awlen_i;           // Burst length
  input [`axi_2t1_int_AXI_AW-1:0]  awaddr_i;
  input [`axi_2t1_int_AXI_BSW-1:0] awsize_i;
  input [`axi_2t1_int_AXI_LTW-1:0] awlock_i;
  input [`axi_2t1_int_AXI_BTW-1:0] awburst_i;
  input [`axi_2t1_int_AXI_CTW-1:0] awcache_i;
  input [`axi_2t1_int_AXI_PTW-1:0] awprot_i;
  //spyglass enable_block W240
  ...
  //SMD: An input has been declared but is not read
  //SJ: These ports are not used 
  input [`axi_2t1_int_AXI_DW-1:0]    wdata_i;         // Write data 
  input [`axi_2t1_int_AXI_SW-1:0]    wstrb_i;         // Write strobes
  //spyglass enable_block W240
  ...
  output [`axi_2t1_int_AXI_BRW-1:0]   bresp_o;     // Write response
  ...
  reg [`axi_2t1_int_AXI_BLW-1:0] arlen_r;  // Burst Length
  ...
  begin : arlen_r_PROC 
    if (!aresetn_i)
      arlen_r <= {`axi_2t1_int_AXI_BLW{1'b0}};
    else
  ...
  // decode errors.
  assign rdata_o     = {`axi_2t1_int_AXI_DW{1'b0}};
  assign rresp_o     = `axi_2t1_int_AXI_RESP_DECERR;    
  ...
  // a decode error.
  assign bresp_o = `axi_2t1_int_AXI_RESP_DECERR;  
