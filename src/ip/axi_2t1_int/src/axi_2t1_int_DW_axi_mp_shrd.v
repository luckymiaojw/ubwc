...
module axi_2t1_int_DW_axi_mp_shrd (
  aclk_i,
  aresetn_i,
...
//----------------------------------------------------------------------
  ...
  parameter ICM_PORT = `axi_2t1_int_AXI_HAS_BICMD;
  ...
  localparam BUS_R_PYLD_S_W
             = R_NUM_VIS_SP*(`axi_2t1_int_AXI_R_PYLD_M_W + ICM_PYLD); 
  ...
  localparam BUS_B_PYLD_S_W
             = B_NUM_VIS_SP*(`axi_2t1_int_AXI_B_PYLD_M_W + ICM_PYLD); 

  // Width of concatenated slave priorities for all visible slave ports.
  localparam R_BUS_PRIORITY_W = `axi_2t1_int_AXI_SLV_PRIORITY_W*R_NUM_VIS_SP;
  localparam B_BUS_PRIORITY_W = `axi_2t1_int_AXI_SLV_PRIORITY_W*B_NUM_VIS_SP;
