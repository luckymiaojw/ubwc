...
module axi_2t1_int_DW_axi_sp_addrch (
  // Inputs - System.
  aclk_i,
  aresetn_i,
...
//----------------------------------------------------------------------
  ...
  parameter BUS_PYLD_S_W = (2*`axi_2t1_int_AXI_AR_PYLD_S_W);
...
// Width of Bus Priority Signals In case QOS if selected                           
 localparam  MASTER_BUS_PRIORITY_W = (ARB_TYPE==4) ? (`axi_2t1_int_AXI_QOSW * NUM_CON_MP) : BUS_PRIORITY_W;
...
//----------------------------------------------------------------------
  ...
  wire [`axi_2t1_int_AXI_MAX_NUM_MST_SLVS-1:0] s_on_w_shrd_only_bus_max;
  // Max sized bus of all AXI_S*_ON_AW_SHARED_VAL parameters.
  wire [`axi_2t1_int_AXI_MAX_NUM_MST_SLVS-1:0] s_on_aw_shrd_bus_max;
  ...
  wire [`axi_2t1_int_AXI_MAX_NUM_MST_SLVS-1:0] max_fac_s_bus_max;
  ...
  wire [`axi_2t1_int_AXI_MAX_NUM_MST_SLVS-1:0] tx_acc_s_bus_max;

  // Registered copy of cpl_tx_shrd_bus_i.
  reg [NSS-1:0] cpl_tx_shrd_bus_r; 
  
  // Max sized version of cpl_tx_shrd_bus_r.
  wire [`axi_2t1_int_AXI_MAX_NUM_MST_SLVS-1:0] cpl_tx_r_bus_max;

  // Max sized bus of tx_cnt_nz_s* signals.
  wire [`axi_2t1_int_AXI_MAX_NUM_MST_SLVS-1:0] tx_cnt_nz_s_bus_max;
  ...
  wire cpl_tx_mux; 
  //assign cpl_tx_mux = `axi_2t1_int_REG_INTER_BLOCK_PATHS ? cpl_tx_r : cpl_tx_i;
...
//tool issue is fixed
  ...
  generate
   if (`axi_2t1_int_AXI_MAX_NUM_MST_SLVS == NSS)
    assign tx_acc_s_bus_max = tx_acc_s_bus;
   else 
    assign tx_acc_s_bus_max = {{(`axi_2t1_int_AXI_MAX_NUM_MST_SLVS - NSS){1'b0}},tx_acc_s_bus};
  endgenerate  
  ...
  generate
   if (`axi_2t1_int_AXI_MAX_NUM_MST_SLVS == NSS)
    ...
    assign cpl_tx_r_bus_max = {{(`axi_2t1_int_AXI_MAX_NUM_MST_SLVS - NSS){1'b0}},cpl_tx_shrd_bus_r};
  endgenerate 
  ...
  generate
    if(SHARED & (NSS >= 1)) begin : gen_tx_cnt_nss1
      axi_2t1_int_DW_axi_sp_addrch_tx_cnt
  ...
  assign s_on_w_shrd_only_bus_max = 
    {(`axi_2t1_int_AXI_S16_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S15_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S14_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S13_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S12_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S11_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S10_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S9_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S8_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S7_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S6_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S5_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S4_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S3_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S2_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S1_ON_W_SHARED_ONLY_VAL == 1),
     (`axi_2t1_int_AXI_S0_ON_W_SHARED_ONLY_VAL == 1)
    };

  assign s_on_aw_shrd_bus_max = 
    {(`axi_2t1_int_AXI_S16_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S15_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S14_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S13_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S12_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S11_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S10_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S9_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S8_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S7_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S6_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S5_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S4_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S3_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S2_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S1_ON_AW_SHARED_VAL == 1),
     (`axi_2t1_int_AXI_S0_ON_AW_SHARED_VAL == 1)
    };
  ...
  always @(*) begin : s_on_w_shrd_only_s_bus_PROC
    ...
    // can occur.
    for(slv=0;slv<`axi_2t1_int_AXI_MAX_NUM_MST_SLVS;slv=slv+1) begin
   ...
   begin
    assign max_fac_s_bus_masked = 
      ...
      & (~(  s_on_w_shrd_only_s_bus
          & {NSS{WCH & (`axi_2t1_int_AXI_W_SHARED_LAYER_NM == 1) & `axi_2t1_int_AXI_W_HAS_SHARED_LAYER}}
         ));
   end
   else
   begin
