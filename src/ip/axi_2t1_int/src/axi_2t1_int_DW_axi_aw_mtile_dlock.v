...
module axi_2t1_int_DW_axi_aw_mtile_dlock (
  // Inputs 
  aclk_i,
  aresetn_i,
  bus_valid_i,
 ...
 */
 ...
 localparam WLAST_B4_AW = 
     (`axi_2t1_int_AXI_NUM_MASTERS == 1)
   | (VIS_S0 & (`axi_2t1_int_AXI_NMV_S0 == 1))
   | (VIS_S1 & (`axi_2t1_int_AXI_NMV_S1 == 1))
   | (VIS_S2 & (`axi_2t1_int_AXI_NMV_S2 == 1))
   | (VIS_S3 & (`axi_2t1_int_AXI_NMV_S3 == 1))
   | (VIS_S4 & (`axi_2t1_int_AXI_NMV_S4 == 1))
   | (VIS_S5 & (`axi_2t1_int_AXI_NMV_S5 == 1))
   | (VIS_S6 & (`axi_2t1_int_AXI_NMV_S6 == 1))
   | (VIS_S7 & (`axi_2t1_int_AXI_NMV_S7 == 1))
   | (VIS_S8 & (`axi_2t1_int_AXI_NMV_S8 == 1))
   | (VIS_S9 & (`axi_2t1_int_AXI_NMV_S9 == 1))
   | (VIS_S10 & (`axi_2t1_int_AXI_NMV_S10 == 1))
   | (VIS_S11 & (`axi_2t1_int_AXI_NMV_S11 == 1))
   | (VIS_S12 & (`axi_2t1_int_AXI_NMV_S12 == 1))
   | (VIS_S13 & (`axi_2t1_int_AXI_NMV_S13 == 1))
   | (VIS_S14 & (`axi_2t1_int_AXI_NMV_S14 == 1))
   | (VIS_S15 & (`axi_2t1_int_AXI_NMV_S15 == 1))
   | (VIS_S16 & (`axi_2t1_int_AXI_NMV_S16 == 1));
 ...
 */
  ...
  wire [`axi_2t1_int_AXI_MAX_NUM_MST_SLVS-1:0] vis_bus;
  integer slv;
  assign vis_bus = 
    {(VIS_S16 ? 1'b1 : 1'b0),
     (VIS_S15 ? 1'b1 : 1'b0),
   ...
   */
  wire [`axi_2t1_int_AXI_MAX_NUM_MST_SLVS-1:0] non_lcl_slv_bus;
  assign non_lcl_slv_bus = 
    {(`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S16 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S15 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S14 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S13 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S12 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S11 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S10 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S9 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S8 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S7 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S6 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S5 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S4 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S3 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S2 ? 1'b1 : 1'b0),
     (`axi_2t1_int_AXI_ACC_NON_LCL_SLV_S1 ? 1'b1 : 1'b0),
  ...
  always @(*) begin : vis_non_lcl_slv_bus_PROC
    ...
    for(ss=0;ss<`axi_2t1_int_AXI_MAX_NUM_MST_SLVS;ss=ss+1) begin
      if(vis_bus[ss]) begin
