...
module axi_2t1_int_DW_axi_lp (
  ...
  input      [`axi_2t1_int_AXI_NUM_MASTERS-1:0] awpendtrans_i;  // Number of pending transitions on write address channel of all Masters
  input      [`axi_2t1_int_AXI_NUM_MASTERS-1:0] arpendtrans_i;  // Number of pending transitions on read address channel of all Masters

  input      [`axi_2t1_int_AXI_NUM_MASTERS-1:0] awvalid_m_i;    // Masters awvalid bus
  input      [`axi_2t1_int_AXI_NUM_MASTERS-1:0] arvalid_m_i;    // Masters arvalid_m bus
  ...
  axi_2t1_int_DW_axi_lpfsm
   #(
    `axi_2t1_int_AXI_LOWPWR_NOPX_CNT,
    `axi_2t1_int_AXI_LOG2_LOWPWR_NOPX_CNT
  )
  U_DW_axi_lpfsm (
     // Inputs
     .aclk         (aclk_i),
