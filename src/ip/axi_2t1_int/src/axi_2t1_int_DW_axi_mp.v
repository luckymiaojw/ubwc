...
//----------------------------------------------------------------------
  ...
  localparam ICM_PYLD = `axi_2t1_int_AXI_HAS_BICMD*`axi_2t1_int_AXI_LOG2_NM;
  ...
  localparam BUS_R_PYLD_S_W
             = R_NVS*(`axi_2t1_int_AXI_R_PYLD_M_W + ICM_PYLD);
  ...
  localparam BUS_B_PYLD_S_W
             = B_NVS*(`axi_2t1_int_AXI_B_PYLD_M_W + ICM_PYLD);

  // Width of concatenated slave priorities for all visible slave ports.
  localparam R_BUS_PRIORITY_W = `axi_2t1_int_AXI_SLV_PRIORITY_W*R_NVS;
  localparam B_BUS_PRIORITY_W = `axi_2t1_int_AXI_SLV_PRIORITY_W*B_NVS;

  // Width of active read IDs bus.
  localparam ACT_RIDS_W
             = MAX_URIDA_M*(`axi_2t1_int_AXI_MIDW + ICM_PORT*(`axi_2t1_int_AXI_LOG2_NM));
  ...
  localparam ACT_WIDS_W
             = MAX_UWIDA_M*(`axi_2t1_int_AXI_MIDW + ICM_PORT*(`axi_2t1_int_AXI_LOG2_NM));
  ...
  localparam AW_IRS_DO_MASKING
    = (`axi_2t1_int_AXI_AW_TMO!=0);
  localparam AW_IRS_ARB_PL_DO_MASKING
    = (`axi_2t1_int_AXI_AW_TMO==0) & (`axi_2t1_int_AXI_AW_PL_ARB==1);

  localparam AR_IRS_DO_MASKING
    = (`axi_2t1_int_AXI_AR_TMO!=0);
  localparam AR_IRS_ARB_PL_DO_MASKING
    = (`axi_2t1_int_AXI_AR_TMO==0) & (`axi_2t1_int_AXI_AR_PL_ARB==1);

  localparam W_IRS_DO_MASKING
    = (`axi_2t1_int_AXI_W_TMO!=0);
  localparam W_IRS_ARB_PL_DO_MASKING
    = (`axi_2t1_int_AXI_W_TMO==0) & (`axi_2t1_int_AXI_W_PL_ARB==1);

  // Must use the slave ID width if this is an ICM port.
  localparam AW_PYLD_ID_RHS = ICM_PORT
                              ? `axi_2t1_int_AXI_AWPYLD_ID_RHS_S
                              : `axi_2t1_int_AXI_AWPYLD_ID_RHS_M;

  localparam AW_PYLD_ID_LHS = ICM_PORT
                              ? `axi_2t1_int_AXI_AWPYLD_ID_LHS_S
                              : `axi_2t1_int_AXI_AWPYLD_ID_LHS_M;

  localparam AR_PYLD_ID_RHS = ICM_PORT
                              ? `axi_2t1_int_AXI_ARPYLD_ID_RHS_S
                              : `axi_2t1_int_AXI_ARPYLD_ID_RHS_M;

  localparam AR_PYLD_ID_LHS = ICM_PORT
                              ? `axi_2t1_int_AXI_ARPYLD_ID_LHS_S
                              : `axi_2t1_int_AXI_ARPYLD_ID_LHS_M;

  localparam W_PYLD_ID_RHS = ICM_PORT
                             ? `axi_2t1_int_AXI_WPYLD_ID_RHS_S
                             : `axi_2t1_int_AXI_WPYLD_ID_RHS_M;

  localparam W_PYLD_ID_LHS = ICM_PORT
                             ? `axi_2t1_int_AXI_WPYLD_ID_LHS_S
                             : `axi_2t1_int_AXI_WPYLD_ID_LHS_M;
...
//----------------------------------------------------------------------
  ...
  `define axi_2t1_int_LCL_AR_PYLD_W `axi_2t1_int_AXI_AR_PYLD_M_W
  `define axi_2t1_int_LCL_AW_PYLD_W `axi_2t1_int_AXI_AW_PYLD_M_W
  `define axi_2t1_int_LCL_W_PYLD_W  `axi_2t1_int_AXI_W_PYLD_M_W

  `define axi_2t1_int_LCL_R_M_PYLD_W  `axi_2t1_int_AXI_R_PYLD_M_W
  `define axi_2t1_int_LCL_R_S_PYLD_W  `axi_2t1_int_AXI_R_PYLD_M_W

  `define axi_2t1_int_LCL_B_M_PYLD_W  `axi_2t1_int_AXI_B_PYLD_M_W
  `define axi_2t1_int_LCL_B_S_PYLD_W  `axi_2t1_int_AXI_B_PYLD_M_W

  `define axi_2t1_int_ID_W `axi_2t1_int_AXI_MIDW

  `define axi_2t1_int_R_PYLD_ICM_W `axi_2t1_int_LCL_R_M_PYLD_W
  `define axi_2t1_int_B_PYLD_ICM_W `axi_2t1_int_LCL_B_M_PYLD_W
...
//----------------------------------------------------------------------
  ...
  input [`axi_2t1_int_LCL_AR_PYLD_W-1:0]  arpayload_i;  // Channel payload vector.
  ...
  output                        ar_shrd_ch_req_o; // Request for AR
                                                  // shared layer.
  output [`axi_2t1_int_AXI_AR_PYLD_S_W-1:0] arpayload_o;   // Payload to slave
                                               // ports.
  ...
  output [`axi_2t1_int_LCL_R_M_PYLD_W-1:0]  rpayload_o; // Payload vector to
                                            // external master.
  // Signal will not be used if the shared layer is performing all channel
  // sink functions for this master on the B channel
  ...
  input [`axi_2t1_int_ID_W-1:0] rcpl_id_shrd_i;
  //spyglass enable_block W240
  ...
  input                         awvalid_i;    // Valid from external
                                              // master.
  input [`axi_2t1_int_LCL_AW_PYLD_W-1:0]  awpayload_i;  // Channel payload vector.
  //spyglass enable_block W240
  ...
  output                        aw_shrd_ch_req_o; // Request for AW
                                                  // shared layer.
  output [`axi_2t1_int_AXI_AW_PYLD_S_W-1:0] awpayload_o;   // Payload to master
                                               // interfaces.
  ...
  input [`axi_2t1_int_LCL_W_PYLD_W-1:0]  wpayload_i; // Payload from external
                                         // master.
  ...
  output                       w_shrd_ch_req_o; // Request for W
                                                // shared layer.
  output [`axi_2t1_int_AXI_W_PYLD_S_W-1:0] wpayload_o;   // Payload to slave ports.
  ...
  output [`axi_2t1_int_LCL_B_M_PYLD_W-1:0] bpayload_o; // Payload vector to external
                                           // master.
  ...
  input [`axi_2t1_int_ID_W-1:0] wcpl_id_shrd_i;
  //spyglass enable_block W240
  ...
  wire [`axi_2t1_int_ID_W-1:0]      rcpl_id_lcl; // burst response channels.
  wire                  wcpl_tx_lcl;
  wire [`axi_2t1_int_ID_W-1:0]      wcpl_id_lcl;
  wire                  rcpl_tx; // Selected between shared and local
  wire [`axi_2t1_int_ID_W-1:0]      rcpl_id; // completion signals.
  wire                  wcpl_tx;
  wire [`axi_2t1_int_ID_W-1:0]      wcpl_id;
  ...
  wire                        arready_mp;
  wire [`axi_2t1_int_AXI_AR_PYLD_S_W-1:0] arpayload_mp;
  wire [`axi_2t1_int_AXI_AR_PYLD_S_W-1:0] arpayload_prereg;

  wire [`axi_2t1_int_ID_W-1:0]            ar_id_irs;
  wire [LOG2_NUM_VIS_SP-1:0]  ar_local_slv_irs;

  wire [`axi_2t1_int_ID_W-1:0]            ar_id_irs_arbpl;
  wire [LOG2_NUM_VIS_SP-1:0]  ar_local_slv_irs_arbpl;

  wire [`axi_2t1_int_ID_W-1:0]            ar_id_irs_mux;
  wire [LOG2_NUM_VIS_SP-1:0]  ar_local_slv_irs_mux;


  wire [NUM_VIS_SP-1:0]       bus_arvalid_irs;
  wire                        arready_irs;
  wire [`axi_2t1_int_AXI_AR_PYLD_S_W-1:0] arpayload_irs;

  wire [NUM_VIS_SP-1:0]       bus_awvalid_mp;
  wire                        awvalid_mp;
  wire                        awmask_valid_mp;
  wire                        awready_mp;
  wire [`axi_2t1_int_AXI_AW_PYLD_S_W-1:0] awpayload_mp;
  wire [`axi_2t1_int_AXI_AW_PYLD_S_W-1:0] awpayload_prereg;

  wire [`axi_2t1_int_ID_W-1:0]            aw_id_irs;
  wire [LOG2_NUM_VIS_SP-1:0]  aw_local_slv_irs;

  wire [`axi_2t1_int_ID_W-1:0]            aw_id_irs_arbpl;
  wire [LOG2_NUM_VIS_SP-1:0]  aw_local_slv_irs_arbpl;

  wire [`axi_2t1_int_ID_W-1:0]            aw_id_irs_mux;
  ...
  wire                        awready_irs;
  wire [`axi_2t1_int_AXI_AW_PYLD_S_W-1:0] awpayload_irs;

  wire [NUM_VIS_SP-1:0]       bus_wvalid_mp;
  wire                        wvalid_mp;
  wire                        wmask_valid_mp;
  wire                        wready_mp;
  wire [`axi_2t1_int_AXI_W_PYLD_S_W-1:0]  wpayload_mp;

  wire [`axi_2t1_int_ID_W-1:0]            w_id_irs;

  wire [`axi_2t1_int_ID_W-1:0]            w_id_irs_arbpl;

  wire [`axi_2t1_int_ID_W-1:0]            w_id_irs_mux;

  wire [NUM_VIS_SP-1:0]       bus_wvalid_irs;
  wire                        wready_irs;
  wire [`axi_2t1_int_AXI_W_PYLD_S_W-1:0]  wpayload_irs;
  ...
  wire [`axi_2t1_int_AXI_W_PYLD_S_W-1:0] wpayload_prereg_unconn;

  wire r_bus_valid_shrd_o_unconn;
  wire [`axi_2t1_int_R_PYLD_ICM_W-1:0] r_payload_icm_o_unconn;
  wire r_cpl_tx_shrd_bus_o_unconn;

  wire b_bus_valid_shrd_o_unconn;
  wire [`axi_2t1_int_B_PYLD_ICM_W-1:0] b_payload_icm_o_unconn;
  ...
  // region signals
  //wire [`axi_2t1_int_AXI_REGIONW-1:0] arregion_o;
  //wire [`axi_2t1_int_AXI_REGIONW-1:0] awregion_o;
  ...
  #(MS_NUM,                   // Master port system number.
    ...
    `axi_2t1_int_AXI_AR_TMO,              // AR channel timing option.
    `axi_2t1_int_AXI_AR_PL_ARB,           // Is channel arbiter pipelined.
    `axi_2t1_int_AXI_AR_PYLD_M_W,         // AR channel payload width from master.
    `axi_2t1_int_AXI_AR_PYLD_S_W,         // AR channel payload width to slave.
...
// spyglass enable_block W287b
  ...
  // the channel.
  assign ar_id_irs_mux = (`axi_2t1_int_AXI_AR_TMO!=0)
                         ? ar_id_irs
                         : (`axi_2t1_int_AXI_AR_PL_ARB==1)
                           ? ar_id_irs_arbpl
                           : {`axi_2t1_int_ID_W{1'b0}};

  assign ar_local_slv_irs_mux = (`axi_2t1_int_AXI_AR_TMO!=0)
                                ? ar_local_slv_irs
                                : (`axi_2t1_int_AXI_AR_PL_ARB==1)
  ...
  //--------------------------------------------------------------------
  axi_2t1_int_DW_axi_irs
  
  #(`axi_2t1_int_AXI_AR_TMO,          // Channel timing option.
    NUM_VIS_SP,           // Number of visible slave ports.
    `axi_2t1_int_AXI_AR_PL_ARB,       // Is channel arbiter pipelined.
    `axi_2t1_int_AXI_AR_PYLD_S_W,     // Channel payload width.
    LOG2_NUM_VIS_SP,      // Log base of num. visible slave ports.
    `axi_2t1_int_ID_W,                // Master ID width.
  ...
  generate
    if(REMOVE_R == 0) begin : gen_r_drespch
      ...
      //----------------------------------------------------------------
      axi_2t1_int_DW_axi_mp_drespch
      
      #(ICM_PORT,
        R_NVS,               // Number of visible slave ports.
        R_NVS_LOG2,          //
        R_NVS_P1_LOG2,       //
        `axi_2t1_int_AXI_R_PL_ARB,       // Pipeline channel arbiter outputs.
        ...
        BUS_R_PYLD_S_W,      // Width of bus with payloads from all
                             // visible slaves.
        `axi_2t1_int_LCL_R_M_PYLD_W,     // Payload width to master.
        `axi_2t1_int_LCL_R_S_PYLD_W,     // Single payload width from slave port.
        ...
        LOG2_MAX_URIDA_M,    // Log base 2 of MAX_URIDA_M.
        ACT_RSNUMS_W,        // Width of active slave numbers bus.
        `axi_2t1_int_AXI_R_CH,           // Block is being used in a read data
                             // channel here.
    ...
    assign rpayload_o   = {`axi_2t1_int_LCL_R_M_PYLD_W{1'b0}};
  ...
  #(MS_NUM,                   // Master port system number.
    ...
    NUM_VIS_SP,               // Number of visible slave ports.
    LOG2_NUM_VIS_SP,          // Log 2 of number of visible slave ports.
    `axi_2t1_int_AXI_AW_TMO,              // AW channel timing option.
    `axi_2t1_int_AXI_AW_PL_ARB,           // Is channel arbiter pipelined.
    `axi_2t1_int_AXI_AW_PYLD_M_W,         // AW channel payload width from master.
    `axi_2t1_int_AXI_AW_PYLD_S_W,         // AW channel payload width to slave.
  ...
  // Select masking feedback signals from the first pipeline stage in
  // the channel.
  assign aw_id_irs_mux = (`axi_2t1_int_AXI_AW_TMO!=0)
                         ? aw_id_irs
                         : (`axi_2t1_int_AXI_AW_PL_ARB==1)
                           ? aw_id_irs_arbpl
                           : {`axi_2t1_int_ID_W{1'b0}};

  assign aw_local_slv_irs_mux = (`axi_2t1_int_AXI_AW_TMO!=0)
                                ? aw_local_slv_irs
                                : (`axi_2t1_int_AXI_AW_PL_ARB==1)
  ...
  #(`axi_2t1_int_AXI_AW_TMO,          // Channel timing option.
    NUM_VIS_SP,           // Number of visible slave ports.
    `axi_2t1_int_AXI_AW_PL_ARB,       // Is channel arbiter pipelined.
    `axi_2t1_int_AXI_AW_PYLD_S_W,     // Channel payload width.
    LOG2_NUM_VIS_SP,      // Log base of num. visible slave ports.
    `axi_2t1_int_ID_W,                // Master ID width.
   ...
   */
  axi_2t1_int_DW_axi_aw_mtile_dlock
  
  #( .NUM_VIS_SP(NUM_VIS_SP)
    ,.PYLD_W(`axi_2t1_int_AXI_W_PYLD_S_W)
    ,.AW_PL_ARB(`axi_2t1_int_AXI_AW_PL_ARB)
    ,.W_PL_ARB(`axi_2t1_int_AXI_W_PL_ARB)
  ...
  U_DW_axi_aw_mtile_dlock (
    ...
    .wlast_i        (wpayload_o[`axi_2t1_int_AXI_WPYLD_LAST]),
    // Outputs
  ...
  //--------------------------------------------------------------------
  axi_2t1_int_DW_axi_mp_wdatach
  
  #(MS_NUM,                  // Master port system number.
    ICM_PORT,                // Interconnecting master port.
    NUM_VIS_SP,              // Number of visible slave ports.
    LOG2_NUM_VIS_SP,         // Log 2 of number of visible slave ports.
    `axi_2t1_int_AXI_W_TMO,              // W channel timing option.
    `axi_2t1_int_AXI_W_PL_ARB,           // Is channel arbiter pipelined.
    `axi_2t1_int_AXI_W_PYLD_M_W,         // W channel payload width from master.
    `axi_2t1_int_AXI_W_PYLD_S_W,         // W channel payload width to slave.
    ACT_WIDS_W,              // Width of active write IDs bus.
    ACT_WSNUMS_W,            // Width of active slave numbers bus.
    ACT_WCOUNT_W,            // Width of active write count per ID bus.
  ...
  // Select masking feedback signals from the first pipeline stage in
  // the channel.
  assign w_id_irs_mux = (`axi_2t1_int_AXI_W_TMO!=0)
                        ? w_id_irs
                        : (`axi_2t1_int_AXI_W_PL_ARB==1)
                          ? w_id_irs_arbpl
                          : {`axi_2t1_int_ID_W{1'b0}};
  ...
  #(`axi_2t1_int_AXI_W_TMO,          // Channel timing option.
    NUM_VIS_SP,          // Number of visible slave ports.
    `axi_2t1_int_AXI_W_PL_ARB,       // Is channel arbiter pipelined.
    `axi_2t1_int_AXI_W_PYLD_S_W,     // Channel payload width.
    LOG2_NUM_VIS_SP,     // Log base of num. visible slave ports.
    `axi_2t1_int_ID_W,               // Master ID width.
  ...
  generate
    if(REMOVE_B == 0) begin : gen_b_drespch
      ...
      #(ICM_PORT,            // Interconnecting master port.
        ...
        B_NVS_LOG2,          //
        B_NVS_P1_LOG2,       //
        `axi_2t1_int_AXI_B_PL_ARB,       // Pipeline channel arbiter outputs.
        ...
        BUS_B_PYLD_S_W,      // Width of bus with payloads from all
                             // visible slaves.
        `axi_2t1_int_LCL_B_M_PYLD_W,     // Payload width to master.
        `axi_2t1_int_LCL_B_S_PYLD_W,     // Single payload width from slave port.
        ...
        LOG2_MAX_UWIDA_M,    // Log base 2 of MAX_UWIDA_M.
        ACT_WSNUMS_W,        // Width of active slave numbers bus.
        `axi_2t1_int_AXI_NOT_R_CH        // Block is not being used in a read data
                             // channel here.
       )
  ...
  assign bpayload_o = {`axi_2t1_int_LCL_B_M_PYLD_W{1'b0}};
...
`undef axi_2t1_int_LCL_R_M_PYLD_W
`undef axi_2t1_int_LCL_R_S_PYLD_W
`undef axi_2t1_int_LCL_B_M_PYLD_W
`undef axi_2t1_int_LCL_B_S_PYLD_W
