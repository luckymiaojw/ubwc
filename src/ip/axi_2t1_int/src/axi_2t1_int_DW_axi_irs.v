...
//----------------------------------------------------------------------
  ...
  parameter PYLD_W = `axi_2t1_int_AXI_AR_PYLD_M_W; // Width of payload signals in 
                                       // this block.    
...
//----------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------
  assign bus_valid_o = (TMO==`axi_2t1_int_AXI_TMO_COMB)
                       ? bus_valid_i : 
                         ((TMO==`axi_2t1_int_AXI_TMO_FRWD) 
                          ? frwd_bus_valid_mskd
                          : full_valid_mux
                         ); 

  assign payload_o = (TMO==`axi_2t1_int_AXI_TMO_COMB)
                       ? payload_i : 
                         ((TMO==`axi_2t1_int_AXI_TMO_FRWD) 
                           ? frwd_payload_r 
                           : full_payload_mux
  ...
  assign ready_o = (TMO==`axi_2t1_int_AXI_TMO_COMB)
                     ? ready_i : 
                       ((TMO==`axi_2t1_int_AXI_TMO_FRWD) 
                         ? frwd_ready_o 
                         : full_ready
  ...
  assign id_o = (DO_MASKING & (TMO!=`axi_2t1_int_AXI_TMO_COMB))
                ? ((TMO==`axi_2t1_int_AXI_TMO_FRWD)
                    ? frwd_id
                    : full_id
                  )
  ...
  assign local_slv_o = (DO_MASKING & (TMO!=`axi_2t1_int_AXI_TMO_COMB))
                       ? ((TMO==`axi_2t1_int_AXI_TMO_FRWD)
                           ? frwd_local_slv
                           : full_local_slv
                         )
