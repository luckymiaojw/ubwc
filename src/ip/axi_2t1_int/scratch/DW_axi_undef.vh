...
`ifdef ARB_PARK_INDEX
  `undef ARB_PARK_INDEX
`endif 

`ifdef ARB_OP_MODE_NOREG
...
`ifdef ARB_LOG2_NC_P1
  `undef ARB_LOG2_NC_P1
`endif 

`ifdef BUS_PORT_REQ_W
  `undef BUS_PORT_REQ_W
`endif 

`ifdef DRESPCH_ID_RHS
  `undef DRESPCH_ID_RHS
`endif 

`ifdef DRESPCH_ID_LHS
...
`ifdef LCL_R_M_PYLD_W
  `undef LCL_R_M_PYLD_W
`endif 

`ifdef LCL_R_S_PYLD_W
  `undef LCL_R_S_PYLD_W
`endif 

`ifdef LCL_B_M_PYLD_W
  `undef LCL_B_M_PYLD_W
`endif 

`ifdef LCL_B_S_PYLD_W
...
`ifdef BUS_SLOT_MST_W
  `undef BUS_SLOT_MST_W
`endif 

`ifdef MST_REQ_MUX_NUM_DIN
  `undef MST_REQ_MUX_NUM_DIN
`endif 

`ifdef MST_REQ_BMUX_DIN_W
  `undef MST_REQ_BMUX_DIN_W
`endif 

`ifdef MST_REQ_MBMUX_DIN_W
