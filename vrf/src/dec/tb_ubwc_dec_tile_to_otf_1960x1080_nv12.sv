...
module tb_ubwc_dec_tile_to_otf_1960x1080_nv12;

    localparam integer IMG_W = 1960;
    ...
    initial begin
        ...
        $display("");
        $display("========================================================");
        $display("TB: ubwc_dec_tile_to_otf 1960x1080 NV12 frame");
        ...
        if (timeout >= 6000000) begin
            $fatal(1, "Timeout waiting for full 1960x1080 NV12 frame.");
        end
        ...
        $display("PASS: ubwc_dec_tile_to_otf full 1960x1080 NV12 frame completed");
...
`ifdef WAVES
`ifdef FSDB
        $fsdbDumpfile("tb_ubwc_dec_tile_to_otf_1960x1080_nv12.fsdb");
        $fsdbDumpvars(0, tb_ubwc_dec_tile_to_otf_1960x1080_nv12);
        $fsdbDumpMDA(0, tb_ubwc_dec_tile_to_otf_1960x1080_nv12);
`else
        $dumpfile("tb_ubwc_dec_tile_to_otf_1960x1080_nv12.vcd");
        $dumpvars(0, tb_ubwc_dec_tile_to_otf_1960x1080_nv12);
`endif
`endif
    end
